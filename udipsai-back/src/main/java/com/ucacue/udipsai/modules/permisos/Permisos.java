...
public class Permisos {
    ...
    @Column(name = "informes_crear")
    private Boolean informesCrear = false;
    @Column(name = "informes_editar")
    private Boolean informesEditar = false;
    @Column(name = "informes_eliminar")
    private Boolean informesEliminar = false;
    ...
    public List<SimpleGrantedAuthority> getAuthorities() {
        ...
        // Citas
        // Informes
        if (Boolean.TRUE.equals(this.informes)) authorities.add(new SimpleGrantedAuthority("PERM_INFORMES"));
        if (Boolean.TRUE.equals(this.informesCrear)) authorities.add(new SimpleGrantedAuthority("PERM_INFORMES_CREAR"));
        if (Boolean.TRUE.equals(this.informesEditar)) authorities.add(new SimpleGrantedAuthority("PERM_INFORMES_EDITAR"));
        if (Boolean.TRUE.equals(this.informesEliminar)) authorities.add(new SimpleGrantedAuthority("PERM_INFORMES_ELIMINAR"));
    ...
    public void updateFrom(Permisos other) {
        ...
        this.informes = other.informes;
        this.informesCrear = other.informesCrear;
        this.informesEditar = other.informesEditar;
        this.informesEliminar = other.informesEliminar;
